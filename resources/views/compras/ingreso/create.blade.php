    ...
    <div class="row">
        ...
        <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
            <div class="form-group">
                ...
                <input type="checkbox" value="1" name="impuesto" id="impuesto" class="checkbox">21% Impuesto
            </div>
        </div>
    </div>
    <div class="row">
        <div class="panel panel-primary">
            <div class="panel-body">
                <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                    ...
                    <a href="{{url('almacen/articulo/create')}}" target="_blank"><button type="button" class="btn btn-warning">+ Articulo</button></a>
                </div>
